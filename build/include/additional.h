...
#ifndef LUACODE_MACROS_API
#define LUACODE_MACROS_API extern "C"
#endif

LUACODE_MACROS_API double macros_lua_tonumber(lua_State* L, int i);
LUACODE_MACROS_API int macros_lua_tointeger(lua_State* L, int i);
LUACODE_MACROS_API unsigned macros_lua_tounsigned(lua_State* L, int i);

LUACODE_MACROS_API void macros_lua_pop(lua_State* L, int n);

LUACODE_MACROS_API void macros_lua_newtable(lua_State* L);
LUACODE_MACROS_API void* macros_lua_newuserdata(lua_State* L, size_t s);

LUACODE_MACROS_API int macros_lua_strlen(lua_State* L, int i);

LUACODE_MACROS_API int macros_lua_isfunction(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_istable(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_islightuserdata(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_isnil(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_isboolean(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_isvector(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_isthread(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_isnone(lua_State* L, int n);
LUACODE_MACROS_API int macros_lua_isnoneornil(lua_State* L, int n);

// LUACODE_API void macros_lua_pushliterals(lua_State* L, const char* s); not working idk
LUACODE_MACROS_API void macros_lua_pushcfunction(lua_State* L, lua_CFunction fn, const char* debugname);
LUACODE_MACROS_API void macros_lua_pushcclosure(lua_State* L, lua_CFunction fn, const char* debugname, int nup);

LUACODE_MACROS_API void macros_lua_setglobal(lua_State* L, const char* s);
LUACODE_MACROS_API int macros_lua_getglobal(lua_State* L, const char* s);

LUACODE_MACROS_API const char* macros_lua_tostring(lua_State* L, int i);
